...
```shell
cd ~/TankZhou/software/install/frp_0.21.0_linux_amd64
nohup /home/tankzhou/TankZhou/software/install/frp_0.21.0_linux_amd64/frpc -c /home/tankzhou/TankZhou/software/install/frp_0.21.0_linux_amd64/frpc.ini &
```

在开始菜单中，选择 `startup applications preferences` ，添加对应的启动项，其中，**command** 部分填上 **my_frp.sh** 的路径。
